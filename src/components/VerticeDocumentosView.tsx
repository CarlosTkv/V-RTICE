...
const INITIAL_DOCUMENTS: DocFiscal[] = [
  {
    ...
    numero: '000048291',
    serie: '001',
    chave: '33260933000199550010000482911857391234',
    dataEmissao: '2026-09-10',
    emitente: 'Distribuidora de Alimentos Carioca Ltda',
    emitenteCnpj: '12.345.678/0001-99',
    destinatario: 'Mercadinho do Rio Seco Eireli',
    destinatarioCnpj: '98.765.432/0001-10',
    valorTotal: 4850.00,
    valorIcms: 873.00,
    valorIss: 0,
    cfop: '5102', // Venda de mercadoria
    ncm: '1006.10.91', // Arroz Beneficiado (Alerta: Monofásico / Isenção no Simples)
    status: 'Autorizada',
    manifestacao: 'Confirmada',
    direcao: 'entrada',
    itens: [
      { descricao: 'ARROZ TIPO 1 INTEGRAL 5KG', ncm: '1006.10.91', cfop: '5102', valor: 4850.00, icmsAliquota: 18 }
    ]
  },
  {
    id: 'doc_2',
    ...
    numero: '202600012',
    serie: 'NFS',
    chave: 'NFS33045578472912026000000000128472911223',
    dataEmissao: '2026-09-12',
    emitente: 'Vértice Consultoria Tributária & Auditoria',
    emitenteCnpj: '44.821.902/0001-55',
    destinatario: 'Tecnologia Avançada Soluções S/A',
    destinatarioCnpj: '10.203.405/0001-88',
    valorTotal: 15000.00,
    valorIcms: 0,
    valorIss: 750.00,
    cfop: '0000', // NFS-e não usa CFOP padrão, mas alguns sistemas usam RPS
    ncm: '00000000',
    status: 'Autorizada',
    manifestacao: 'Confirmada',
    direcao: 'saida',
    itens: [
      { descricao: 'SERVIÇOS DE AUDITORIA FISCAL DIGITAL', ncm: '00000000', cfop: '0000', valor: 15000.00, issAliquota: 5 }
    ]
  },
  {
    id: 'doc_3',
    ...
    numero: '000048292',
    serie: '001',
    chave: '3326091020340500188550010000482921857391235',
    dataEmissao: '2026-09-14',
    emitente: 'Indústria Metalúrgica do Vale Ltda',
    emitenteCnpj: '10.203.405/0001-88',
    destinatario: 'Mercadinho do Rio Seco Eireli',
    destinatarioCnpj: '98.765.432/0001-10',
    valorTotal: 12450.00,
    valorIcms: 1494.00,
    valorIss: 0,
    cfop: '6101', // Alerta: CFOP 6101 (Interestadual) mas CNPJ emitente e destinatário ambos têm endereço no RJ (Divergência Crítica de UF!)
    ncm: '7318.15.00', // Parafusos de Ferro ou Aço
    status: 'Autorizada',
    manifestacao: 'Ciência',
    direcao: 'entrada',
    itens: [
      { descricao: 'PARAFUSOS SEXTAVADOS METÁLICOS 1/2', ncm: '7318.15.00', cfop: '6101', valor: 12450.00, icmsAliquota: 12 }
    ]
  },
  {
    id: 'doc_4',
    ...
    numero: '000012903',
    serie: '003',
    chave: '33260905040302000188570030000129031857391236',
    dataEmissao: '2026-09-15',
    emitente: 'Logística Expressa & Transportes Rápidos',
    emitenteCnpj: '05.040.302/0001-88',
    destinatario: 'Mercadinho do Rio Seco Eireli',
    destinatarioCnpj: '98.765.432/0001-10',
    valorTotal: 1800.00,
    valorIcms: 216.00,
    valorIss: 0,
    cfop: '5352', // Prestação de serviço de transporte
    ncm: '00000000',
    status: 'Autorizada',
    manifestacao: 'Confirmada',
    direcao: 'entrada',
    itens: [
      { descricao: 'TRANSPORTE DE PRODUTOS ALIMENTÍCIOS', ncm: '00000000', cfop: '5352', valor: 1800.00, icmsAliquota: 12 }
    ]
  },
  {
    id: 'doc_5',
    ...
    numero: '000184920',
    serie: '002',
    chave: '33260998765432000110650020001849201857391237',
    dataEmissao: '2026-09-18',
    emitente: 'Mercadinho do Rio Seco Eireli',
    ...
    valorIcms: 0,
    valorIss: 0,
    cfop: '5405', // Venda de produto com ICMS ST retido anteriormente
    ncm: '2202.10.00', // Refrigerantes (Alerta: Alíquota incorreta destacada ou falta de indicação do monofásico)
    status: 'Autorizada',
    manifestacao: 'Confirmada',
    direcao: 'saida',
    itens: [
      { descricao: 'REFRIGERANTE COCA-COLA LATA 350ML', ncm: '2202.10.00', cfop: '5405', valor: 154.90, icmsAliquota: 0 }
    ]
  }
].map(d => ({
  ...d,
